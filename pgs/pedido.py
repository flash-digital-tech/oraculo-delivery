...
async def showPedido():
    ...
    19. Se ele disser que não tem nenhuma observação a fazer cite o nome dele e informe que o pagamento é feito pela chave do PIX: 31983352900 e que assim que o sistema confirmar o pagamento será preparado o pedido e entregue.
    20. Se ele disser "ok", "tudo bem", "muito obrigado" ou qualquer frase positiva finalize a conversa agradecendo por ter dado a preferência ao Frigorífico Mantiqueira e que qualquer coisa estaremos à disposição.
